          ...
          <div class="item-address">
            ...
            <div class="addr-list clearfix">
              <div
                ...
                @click="checkedAdd(index)"
              >
                <h2>{{item.receiverName}}</h2>
                <div class="phone">{{item.receiverMobile}}</div>
                <div class="street">{{item.receiverProvince}} {{item.receiverCity}} {{item.receiverDistrict}}<br>{{item.receiverDistrict}}</div>
                <div class="action">
    ...
    getCartList(){
      this.axios.get('/carts').then((res)=>{
        ...
        this.cartList.map((item)=>{
          //  this.productCount = item.quantity + this.productCount
