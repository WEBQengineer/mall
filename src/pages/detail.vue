      ...
      <div class="container clearfix">
        ...
        <div class="content">
          ...
          <div class="item-version">
            <h2>选择版本</h2>
            <self-radio :radioItems='radioItems' @onchecked="onChecked" ></self-radio>
          </div>
          ...
          <div class="item-total">
            <div class="phone-info clearfix">
              <div class="fl">小米9 {{checkedSpe}} 深灰色</div>
...
import SelfRadio from 'components/SelfRadio';
export default{
  name:'detail',
  data(){
    return {
